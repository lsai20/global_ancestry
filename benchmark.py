...
def majorityPop(indivs, k):
	...
	# Note majPops[s] = majority pop of cluster s, majFracs[s] = % cluster s that is max 
	# cluster sizes could be used to find weighted avg
...
#runBenchmark(N=200, M=100, K=3, usePCA=False, n_components=2)
